...
var htmlGenerator = {
     ...
     */
    generate: function (tree, outputDir) {
    ...
    generateFeaturePages: function (treeNode) {
        if (treeNode.type == 'featurefile') {
            var output = Mustache.render(htmlGenerator.htmlTemplates.feature, { document: treeNode.document, rootFolder: treeNode.rootFolder }, htmlGenerator.htmlTemplates);
    ...
    generateTagHtml: function (tree, tag, outputDir) {
        var output = Mustache.render(htmlGenerator.htmlTemplates.tag, { tag: tag, scenaria: tree.scenariaPerTag[tag], rootFolder: '../' }, htmlGenerator.htmlTemplates);
